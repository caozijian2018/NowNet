<template>
    ...
    >
        <div class="display_none head_position width_90 box_szing phone_width_100 phone_relative">
        ...
        <div class="navigation_positoin width_70 display_none phone_none cursor" >
